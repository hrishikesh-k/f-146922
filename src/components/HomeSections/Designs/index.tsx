    ...
    <div className="w-full-container text-textContrastColor bg-tertiary relative border-b-4 border-borderColor">
      ...
      <div className="flex flex-wrap">
      {
        data.map((project, index) => {
          ...
          return <div className={`w-full md:mb-4 mb-8 md:flex flex-wrap ${isOdd && 'flex-row-reverse'}`} key={project.id}>
            <Image className="w-full min-w-80 mb-4 md:w-1/3 border-4 border-borderColor" src={project.image} alt={project.name} width="520" height="150" />
